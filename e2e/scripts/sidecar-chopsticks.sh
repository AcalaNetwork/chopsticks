...
# run chopsticks node
yarn run start dev --endpoint wss://rpc.polkadot.io --port 8011 & POLKADOT_PID=$!
yarn run start dev --endpoint wss://statemint-rpc.polkadot.io --port 8012 & STATEMINT_PID=$!
